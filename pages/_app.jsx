...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/veR37TpbF3",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=1106268330198835241&permissions=8&scope=applications.commands%20bot",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/1106268330198835241/vote",
    },
    {
      link: true,
      name: "Partners",
